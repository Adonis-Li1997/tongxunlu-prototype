...
| 源页面 | 触发元素 | 目标页面 | 条件 |
|---|---|---|---|
| `empty-state` | 「导入联系人」按钮 | `import` | — |
| `empty-state` | 「手动添加」按钮 | `contact-add` | — |
| `empty-state` | 右上角「设置」图标 | `settings` | — |
| `home` | 搜索框 | `search` | — |
